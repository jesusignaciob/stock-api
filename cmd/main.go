...
import (
	...
	// migrate_driver "github.com/golang-migrate/migrate/v4/database/postgres"
	migrate_driver "github.com/golang-migrate/migrate/v4/database/cockroachdb"
...
func setupRoutes(router *gin.Engine) {
	...
	api.GET("/stocks", httpHandler.FindAllStocks)
}
